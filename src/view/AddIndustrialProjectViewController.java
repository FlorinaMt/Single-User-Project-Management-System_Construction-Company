...
/**
 * A view controller handling the industrial project windows
 * @author Matej Palas
 * @author Michael Barczuk
 */
public class AddIndustrialProjectViewController
{
  ...
  //  For industrial project fields
  @FXML private TextField sizeField;
  @FXML private TextField useOfBuildingField;
  //  Resources fields
  ...
  private Industrial projectToEdit;
  /**
   * Default no argument constructor
   */
  public AddIndustrialProjectViewController()
  {
  }
  /**
      ...
      Function function)  //  This method gets called only once
  {
    ...
    this.model = model;
    this.root = root;
    reset(function, viewState);    //  Calling the reset function in initialize, sets the fields depending on the function of the window
  }
  /**
   ...
   */
  public void reset(
      Function function, ViewState viewState)    //  Reset gets called everytime after initializing method
  {
    ...
    if (viewState != null)
      this.projectToEdit = (Industrial) viewState.getProject();
    ...
    switch (function)
    {
      ...
      case edit ->
      {
        ...
        this.title.setText("Edit an Industrial Project");
      ...
      case display ->
      {
        if(viewState.getProjects()!=null)
        {
          ...
          this.title.setText("Displaying Industrial Project");
  ...
  private void saveEditButtonPressed()
  {
    ...
    try
    {
      ...
      projectToEdit.edit(Double.parseDouble(budgetField.getText()),
          ...
          true, useOfBuildingField.getText(), resources);
      viewHandler.openView("displayIndustrial", viewState);
    }
    catch (Exception e)
    {
  ...
  @FXML private void addPressed()
  {
    switch (function)
    {
      ...
      {
        errorLabel.setText("");
        viewHandler.openView("editIndustrial", viewState);
      }
      case edit ->
      {
        errorLabel.setText("");
   ...
   */
  //  If one radio button is selected other is disabled, this is used in the behind or notBehind for example
